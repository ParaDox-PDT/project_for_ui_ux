...
class UzbekistanFlagScreen extends StatefulWidget {
  const UzbekistanFlagScreen({super.key});

  @override
  State<UzbekistanFlagScreen> createState() => _UzbekistanFlagScreenState();
}

class _UzbekistanFlagScreenState extends State<UzbekistanFlagScreen> {
  @override
